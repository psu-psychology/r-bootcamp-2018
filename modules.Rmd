...
- [R-eproducible Psychological Science](talks/r-eproducible-science.html) | [Download R Markdown](talks/r-eproducible-science.Rmd).
- [R Markdown example](talks/bootcamp-survey.html) using our own survey data.
- Complete APA format manuscript based on `papaja` using the survey data, both in the original R Markdown format [Downloadable](talks/gilmore-hallquist-bootcamp-2018-papaja.Rmd) version and the final [PDF](talks/gilmore-hallquist-bootcamp-2018-papaja.Rmd) version.
...
- Michael Hallquist [introduction to parallel R](talks/parallel_r.html) | [Rmd](talks/parallel_r.Rmd)
