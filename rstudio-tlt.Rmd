...
2. A web browser.
3. A computer that is connected to the Penn State network via
    - [PSU wifi](http://wireless.psu.edu/wireless.html), or
    - a physical network connection, or
    - a connection to Penn State's network via a [Virtual Private Network (VPN)](http://kb.its.psu.edu/article/891) application like Cisco AnyConnect.
...
3. Connect to [https://lxclusterapps.tlt.psu.edu:8788](https://lxclusterapps.tlt.psu.edu:8788) or to [https://lxclusterapps-dev.tlt.psu.edu:8787/auth-sign-in](https://lxclusterapps-dev.tlt.psu.edu:8787/auth-sign-in)
...
2. Enter your Penn State Access ID (e.g. rog1) and password.
    - You should see the WebFiles interface:
