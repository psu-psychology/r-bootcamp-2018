...
3. Connect to [https://lxclusterapps.tlt.psu.edu:8788](https://lxclusterapps.tlt.psu.edu:8788) or to [https://lxclusterapps-dev.tlt.psu.edu:8787/auth-sign-in](https://lxclusterapps-dev.tlt.psu.edu:8787/auth-sign-in). You should see the following login page:
