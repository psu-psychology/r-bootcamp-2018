...
- Creates *.Rproj file (the asterisk is a wildcard character meaning that any number of characters can precede the period)
- Turn-off saving data to the .RData file (Tools/Global Options... and/or Tools/Project Options...)
...
Over the lunch break, I analyzed the survey data you provided using an R Markdown document [bootcamp-survey.Rmd](bootcamp-survey.Rmd).
...
No problem.
Just re-render your file with `output_format="pdf_document"`.
Your collaborator prefers MS Word?
Got it covered.
Try `output_format="word_document"`.
Need to give a quick brown bag talk you can give from any web browser?
Easy.
Use `output_format="ioslides_presentation"`.

### More about R Markdown

I have just learned that there is a new book coming out called *R Markdown: The Definitive Guide* by Yihui Xie, J. J. Allaire, Garrett Grolemund.
Here is a link to the e-version of the book: <https://bookdown.org/yihui/rmarkdown/>.
I've only just started digging in, but I really like what I see so far.
I'm pretty sure I'll buy a hard copy, since I like to have paper copies of technical books.
